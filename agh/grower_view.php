...
<div class="container">
	...
	<?php
		...
		$sql = "SELECT * FROM grower WHERE id = " . $id;
  ...
  <h1 class="my-4 text-center"><?php echo $row["name"]; ?></h1>
	...
	<form action="functions.php" method="post">
		<input type="hidden" id="form" name="form" value="grower_update" >
		<input type="hidden" id="grower_id" name="grower_id" value="<?php echo $row["id"]; ?>" >
		<div class="row">
		    <div class="col-sm">
